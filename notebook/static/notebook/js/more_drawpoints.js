...
define([
    ...
    var load = function (keyboard_manager, notebook) {
        $('#draw-points-menu').click(function () {

            var form_variable = $('<div/>').addClass('form-group')
                .append(
                    $('<label/>').addClass('col-sm-2')
                        .addClass('control-label')
                        .attr('for', 'draw_points_variable')
            ...
            dialog.modal({
                ...
                buttons: {
                    'Run': {
                        ...
                        click: function () {
                            var Value = {
                                "variable": $("#draw_points_variable").val(),
                                "x_field": $("#draw_points_x_field").val(),
                                "y_field": $("#draw_points_y_field").val(),
                                "target": "points",
                            };
                            ...
                            if (Value.variable === "" || !/^[a-zA-Z_][0-9a-zA-Z_]*$/.test(Value.variable)) {
                                ...
                                $("#draw_points_form div label").css("color", "#000");
                            ...
                            if (Value.x_field === "") {
                                ...
                                content_1 = '# Draw Points\n';
                                content_2 = 'sjs_load_data.draw_points({0},x_field="{1}",y_field="{2}")\n'.format(Value.variable,Value.x_field,Value.y_field);
                                content = content_1 + content_2
                            }
